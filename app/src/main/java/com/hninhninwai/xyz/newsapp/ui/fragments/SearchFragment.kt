...
import com.hninhninwai.xyz.newsapp.databinding.FragmentSearchBinding
...
import com.hninhninwai.xyz.newsapp.utils.Constants.Companion.SEARCH_NEWS_TIME_DELAY
   ...
   lateinit var itemSearchError : CardView
    ...
    val scrollListener = object : RecyclerView.OnScrollListener() {
        override fun onScrolled(recyclerView: RecyclerView, dx: Int, dy: Int) {
            ...
            val shouldPaginate = isNoError && isNotLoadingAndLastPage && isAtLastItem && isNotAtBeginning && isTotalMoreThanVisible && isScrolling
            if(shouldPaginate) {
                newsViewModel.searchNews(binding.searchEdit.text.toString())
                isScrolling = false
            }
